...
//        
        ...
        Persona nahim=new Persona("Nahim", "Marulanda","Picis");
        ...
        //Consumir el objeto libro
        Libro titutlo= new Libro("Los andes", nahim, 45, true);
        System.out.println(titutlo.toString());    
